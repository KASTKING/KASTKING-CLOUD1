package com.kastking.generator.controller;
...
import com.kastking.common.utils.security.PermissionUtils;
import com.kastking.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        response.reset();
        response.setHeader("Content-Disposition" , "attachment; filename=\"kastking.zip\"");
